...
def LoadDataset(fold = 0):
    ...
    trainDataset = seqData(
                           datapath='./data/datasets/DataS1.csv',
                           cv_data_path='./data/datasets/fivefold_val_flags(DataS1).csv',
...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=LR, weight_decay=0.01) #0.01/1e-4
