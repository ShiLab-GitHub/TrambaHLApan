...
symbol_dic_FASTA = {'X':0,'Y':1, 'S':2, 'M':3, 'R':4, 'E':5, 'I':6, 'N':7, 'V':8, 'G':9, 'L':10,
                    'D':11, 'T':12, 'W':13, 'H':14, 'K':15, 'A':16, 'F':17, 'Q':18, 'C':19, 'P':20,'*':21} #未知氨基酸符号“X”

class seqData(Dataset):
    def __init__(self, 
                 datapath='./data/datasets/trainingData_EL.csv',
                 cv_data_path='./data/datasets/fivefold_val_flags(trainingData_EL).csv',
                 val_flag = False,
                 fold = 0):
